Public Class FormGolongan
    ...
    Private Sub reset()
        ...
        txtId.Text = koneksi.generateId("GOL", "golongan", "id_golongan", 2)
        txtNama.Text = Nothing
        koneksi.isiDataGrid(DataGridView1, "golongan")
        DataGridView1.Columns(0).HeaderText = "ID"
        DataGridView1.Columns(1).HeaderText = "Golongan"
    End Sub
    Private Sub FormGolongan_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            koneksi.buka()
            reset()
    ...
    Private Sub btnHapus_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnHapus.Click
        Try
            If MessageBox.Show(Me, "Yakin dihapus?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                Dim affectedRows As Integer = koneksi.nonQuery("delete from golongan where id_golongan = '" & txtId.Text & "'")
    ...
    Private Sub btnSimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSimpan.Click
        Try
            If btnSimpan.Text = "Simpan" Then
                Dim affectedRows As Integer = koneksi.nonQuery("insert into golongan values('" & txtId.Text & "', '" & txtNama.Text & "')")
                If affectedRows > 0 Then
                    MessageBox.Show(Me, "Operasi berhasil dilakukan.", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    reset()
                    TabControl1.SelectedIndex = 0
            ...
            ElseIf btnSimpan.Text = "Ubah" Then
                Dim affectedRows As Integer = koneksi.nonQuery("update golongan set nama_golongan = '" & txtNama.Text & "' where id_golongan = '" & txtId.Text & "'")
                If affectedRows > 0 Then
                    MessageBox.Show(Me, "Operasi berhasil dilakukan.", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    reset()
                    TabControl1.SelectedIndex = 0
