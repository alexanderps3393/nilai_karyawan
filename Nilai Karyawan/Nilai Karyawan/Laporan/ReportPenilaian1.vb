...
Public Class ReportPenilaian1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nilai_Karyawan.ReportPenilaian1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Manajer() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReportPenilaian1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportPenilaian1 = New ReportPenilaian1()
        rpt.Site = Me.Site
        Return rpt
    End Function
