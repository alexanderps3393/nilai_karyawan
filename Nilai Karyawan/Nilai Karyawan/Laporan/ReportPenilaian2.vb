...
Public Class ReportPenilaian2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nilai_Karyawan.ReportPenilaian2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Karyawan() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReportPenilaian2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportPenilaian2 = New ReportPenilaian2()
        rpt.Site = Me.Site
        Return rpt
    End Function
